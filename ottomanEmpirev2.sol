...
contract OttomanEmpirev2 {
    ...
    function _Savas_Gucu_(address walletAddress) public view returns (string memory) {
        return pluckName(walletAddress, "SAVAS GUCU", Savasliste);
    }
    
    function _Osmanli_Donanma_Gucu_(address walletAddress) public view returns (string memory) {
        return pluckName(walletAddress, "DONANMA GUCU", Donanma_Gucu);
    }
    
    function _Suvari_Gucu_(address walletAddress) public view returns (string memory) {
        return pluckName(walletAddress, "SUVARIGUCU", SuvariListesi);
    }
    
    function _Piyade_Gucu_(address walletAddress) public view returns (string memory) {
        return pluckName(walletAddress, "PIYADE GUCU", PiyadeListesi);
    }
    
    function _Politik_Gucu_(address walletAddress) public view returns (string memory) {
        return pluckName(walletAddress, "POLITIK GUCU", PolitikListesi);
    }

    function _Ekonomik_Gucu_(address walletAddress) public view returns (string memory) {
        return pluckName(walletAddress, "EKONOMIK GUCU", EkonomikListe);
    }
    
    function _Savunma_Gucu_(address walletAddress) public view returns (string memory) {
        return pluckName(walletAddress, "SAVUNMA GUCU", SavunmaListe);
    }
    
    function _Silah_(address walletAddress) public view returns (string memory) {
        return pluckName(walletAddress, "SILAH", SilahListe);
    }
    
    function _Yuzuk_(address walletAddress) public view returns (string memory) {
        return pluckName(walletAddress, "YUZUK", YuzukListe);
    }
    
    function Padisah(address walletAddress) public view returns (string memory) {
